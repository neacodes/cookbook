...
def load_new_workout_data_from_apple_health() -> str:
    """
    Uploads the latest workout data from the 
    Apple Health app to the Health DataLake. 
    Before calling this function, explicitly 
    ask the user's consent to see if they want 
    the workout data to be updated
