...
from prod_env_mgmt import prod_env
import logging
...
workout_metrics_service = WorkoutMetricsService(prod_env[EnvKeys.MONGO_USER.value], 
...
def get_run_workout_performance(metric: str, aggregation_type: 
                                str, start_date: str, end_date: str) -> float:
    """
    Calculate various running performance 
    metrics within a specified time period 
    across different running workouts.

    Args:
        metric (str): The running performance 
        metriec to aggregate. Supported metrics 
        include 'distance', 'duration', 'heartRate',
        'heartRateRecovery' and 'calorie'.
        aggregation_type (str): Type of aggregation to 
        perform. Supported types are 'sum', 'average', 
        'max', 'min', and 'count'.
        start_date (str): The start date for data 
        aggregation in 'YYYY-MM-DD' format.
        end_date (str): The end date for data 
        aggregation in 'YYYY-MM-DD' format.
    ...
    """
    return workout_metrics_service.get_run_workout_performance(metric, aggregation_type, start_date, end_date)
...
def get_cycle_workout_performance(metric: str, aggregation_type: str, start_date: str, end_date: str ) -> float:
    ...
    """
    return workout_metrics_service.get_cycle_workout_performance(metric, aggregation_type, start_date, end_date)    
...
def get_walk_workout_performance(metric: str, aggregation_type: str, start_date: str, end_date: str ) -> float:
    ...
    """
    return workout_metrics_service.get_walk_workout_performance(metric, aggregation_type, start_date, end_date) 
...
def get_hike_workout_performance(metric: str, aggregation_type: str, start_date: str, end_date: str ) -> float:
    ...
    """
    return workout_metrics_service.get_hike_workout_performance(metric, aggregation_type, start_date, end_date)
...
def get_tennis_workout_performance(metric: str, aggregation_type: str, start_date: str, end_date: str ) -> float:
    ...
    """
    return workout_metrics_service.get_tennis_workout_performance(metric, aggregation_type, start_date, end_date)   
...
def get_core_workout_performance(metric: str, aggregation_type: str, start_date: str, end_date: str ) -> float:
    ...
    """
    return workout_metrics_service.get_core_workout_performance(metric, aggregation_type, start_date, end_date) 
